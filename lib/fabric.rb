...
require 'fabric/webhooks/charge_dispute_updated'
require 'fabric/webhooks/charge_dispute_closed'
require 'fabric/webhooks/charge_dispute_created'
require 'fabric/webhooks/charge_dispute_funds_reinstated'
require 'fabric/webhooks/charge_dispute_funds_withdrawn'
require 'fabric/webhooks/coupon_created'
require 'fabric/webhooks/coupon_deleted'
require 'fabric/webhooks/coupon_updated'
require 'fabric/webhooks/customer_created'
require 'fabric/webhooks/customer_updated'
require 'fabric/webhooks/customer_deleted'
...
require 'fabric/webhooks/payment_intent_created'
...
require 'fabric/webhooks/payment_intent_canceled'
...
require 'fabric/webhooks/payment_method_automatically_updated'
require 'fabric/webhooks/price_created'
require 'fabric/webhooks/price_deleted'
require 'fabric/webhooks/price_updated'
require 'fabric/webhooks/product_created'
require 'fabric/webhooks/product_deleted'
require 'fabric/webhooks/product_updated'
...
require 'fabric/webhooks/setup_intent_canceled'
...
module Fabric
  ...
  autoload :Price, 'fabric/app/models/fabric/price'
  autoload :Product, 'fabric/app/models/fabric/product'
  autoload :Refund, 'fabric/app/models/fabric/refund'
  autoload :Review, 'fabric/app/models/fabric/review'
